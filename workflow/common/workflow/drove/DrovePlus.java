...
public class DrovePlus extends Drove{
    Queue<Segment> segments = new PriorityQueue<>();
    public DrovePlus(EV ev, WorkflowInfo.WorkflowDAG originalV1, WorkflowInfo.WorkflowDAG originalV2) {
                ...
                if (window.covering && !window.maximal) {
                    ...
                    if (isWindowMaximal && !isDecompositionMaximal) {
                        ...
                        if (!window.tested) {
                            ...
                            Set<String> result = window.getEquivalentSinks(false, null, ev, v1, v2);
