...
import edu.uci.ics.texera.workflow.common.workflow.raven.{CachedSubDAGs, Raven}
...
object TexeraWebApplication {
  ...
  val recycler: Recycler = new Recycler()
  val v2: Raven = new Raven()
  val cachedSubDAGs: CachedSubDAGs = new CachedSubDAGs()

  def getRecyclerGraph(): Recycler = {
    recycler
  }
  ...
  def getCachedWindows(): CachedSubDAGs = {
    cachedSubDAGs
  }
