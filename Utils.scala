...
object Utils {
  ...
  /**
   * These constants are for reasoning the difference between two workflow versions
   *
   */

  final val SCHEMA_DIMENSION_CODE: Byte = 0
  final val TUPLE_DIMENSION_CODE: Byte = 1
  final val ORDER_DIMENSION_CODE: Byte = 2
  final val DIMENSIONS_LENGTH: Byte = 3
  final val NORMAL_OPERATION: Byte = 0
  final val REMOVAL_OPERATION: Byte = 1
